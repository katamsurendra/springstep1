...
public class NoteController {
	...
	NoteRepository noterespository = (NoteRepository) context.getBean("noteRepository");
...
{
	map.addAttribute("note",noterespository.getAllNotes());
	...
	*/
    ...
    public String addNote(@RequestParam("noteId") int noteId,
        ...
        newDetails.setCreatedAt();
        
        
        if(noterespository.exists(noteId))
        {
           return "redirect:/";
       }
        noterespository.addNote(newDetails);

        
        for(Note note :noterespository.getList())
        {
        ...
        model.addAttribute("note",noterespository.getAllNotes());
